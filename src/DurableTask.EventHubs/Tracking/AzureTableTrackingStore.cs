...
namespace DurableTask.EventHubs.Tracking
{
    using System;
    ...
    /// <summary>
    /// Tracking store for use with <see cref="EventHubsOrchestrationService"/>. Uses Azure Tables and Azure Blobs to store runtime state.
    /// </summary>
    class AzureTableTrackingStore : TrackingStoreBase
    {
        ...
        public override async Task<OrchestrationHistory> GetHistoryEventsAsync(string instanceId, string expectedExecutionId, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            EtwEventSource.Log.FetchedInstanceHistory(
        ...
        public override async Task<OrchestrationState> GetStateAsync(string instanceId, string executionId, bool fetchInput)
        {
            ...
            EtwEventSource.Log.FetchedInstanceStatus(
                this.storageAccountName,
                this.taskHubName,
                instanceId,
        ...
        public override async Task<PurgeHistoryResult> PurgeInstanceHistoryAsync(string instanceId)
        {
            ...
            if (orchestrationInstanceStatus != null)
            {
                ...
                EtwEventSource.Log.PurgeInstanceHistory(
                    this.storageAccountName,
                    this.taskHubName,
                    instanceId,
            ...
            string inputStatusOverride)
        {
            ...
            EtwEventSource.Log.InstanceStatusUpdate(
                this.storageAccountName,
                this.taskHubName,
            ...
            string eTagValue)
        {
            ...
            catch (StorageException ex)
            {
                ...
                {
                    EtwEventSource.Log.SplitBrainDetected(
                        this.storageAccountName,
                        this.taskHubName,
                        instanceId,
                        executionId,
            ...
            EtwEventSource.Log.AppendedInstanceHistory(
                this.storageAccountName,
                this.taskHubName,
                instanceId,
                executionId,
