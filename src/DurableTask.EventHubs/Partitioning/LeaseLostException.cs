...
namespace DurableTask.EventHubs.Partitioning
{
    ...
    {
        /// <summary>Initializes a new instance of the <see cref="DurableTask.EventHubs.Partitioning.LeaseLostException" /> class using default values.</summary>
        public LeaseLostException()
            : base()
        {
        }

        /// <summary>Initializes a new instance of the <see cref="DurableTask.EventHubs.Partitioning.LeaseLostException" /> class using specified lease.</summary>
        ...
        /// <see cref="DurableTask.EventHubs.Partitioning.LeaseLostException" /> class using specified lease and the error that caused the exception.</summary> 
        /// <param name="lease">The messaging lease.</param>
        ...
        /// <summary>Initializes a new instance of the 
        /// <see cref="DurableTask.EventHubs.Partitioning.LeaseLostException" /> class using specified error message.</summary> 
        ...
        /// <summary>Initializes a new instance of the 
        /// <see cref="DurableTask.EventHubs.Partitioning.LeaseLostException" /> class using specified error message and inner exception.</summary> 
        /// <param name="message">The message associated with the error.</param>
        /// <param name="innerException">The error that caused the exception.</param>
        ...
        /// <summary>Initializes a new instance of the 
        /// <see cref="DurableTask.EventHubs.Partitioning.LeaseLostException" /> class using specified information and context.</summary> 
