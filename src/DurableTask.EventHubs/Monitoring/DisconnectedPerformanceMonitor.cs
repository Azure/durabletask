...
namespace DurableTask.EventHubs.Monitoring
{
    using System;
    ...
    public class DisconnectedPerformanceMonitor
    {
            ...
            int? maxPollingIntervalMilliseconds = null)
        {
            ...
            this.maxPollingLatency = 
                ...
                (int)EventHubsOrchestrationServiceSettings.DefaultMaxQueuePollingInterval.TotalMilliseconds;
        ...
        {
            CloudQueue workItemQueue = EventHubsOrchestrationService.GetWorkItemQueue(this.storageAccount, this.taskHub);
            CloudQueue[] controlQueues = await EventHubsOrchestrationService.GetControlQueuesAsync(
                this.storageAccount,
                this.taskHub,
                defaultPartitionCount: EventHubsOrchestrationServiceSettings.DefaultPartitionCount);
            ...
            catch (StorageException e) when (e.RequestInformation?.HttpStatusCode == 404)
            {
                ...
                EtwEventSource.Log.GeneralWarning(
