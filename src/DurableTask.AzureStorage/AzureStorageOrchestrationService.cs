...
namespace DurableTask.AzureStorage
{
        ...
        IDisposable
    {
        ...
        internal Task OnIntentLeaseReleasedAsync(BlobLease lease, CloseReason reason)
        {
            ...
            this.orchestrationSessionManager.ReleaseQueue(lease.PartitionId, reason, "Intent Partition Manager");
        ...
        {
            this.orchestrationSessionManager.RemoveQueue(lease.PartitionId, reason, "Ownership Partition Manager");
            return Utils.CompletedTask;
        }
