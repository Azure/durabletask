...
#nullable disable
        ...
        /// <summary>
        /// This method is meant to be used only for testing. It updates the history state in storage based on the new events in
        /// <paramref name="runtimeState"/>, mimicking what <see cref="UpdateStateAsync"/> does in a "light-weight" fashion 
        /// (for example, it does not handle large message compression and uploading to blob storage, etc.)
        /// </summary>
        ...
        /// <param name="runtimeState">The new runtime state of the orchestration with the new history events.</param>
        /// <returns></returns>
        internal async Task UpdateHistoryAsync(string instanceId, string executionId, OrchestrationRuntimeState runtimeState)
        {
            int estimatedBytes = 0;
