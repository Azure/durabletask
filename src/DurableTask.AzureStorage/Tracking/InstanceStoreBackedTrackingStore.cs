...
namespace DurableTask.AzureStorage.Tracking
{
    ...
    class InstanceStoreBackedTrackingStore : TrackingStoreBase
    {
        ...
        /// <inheritdoc />
        public override Task<IList<OrchestrationState>> QueryStateAsync(DateTime createdTimeFrom, DateTime createdTimeTo, String runtimeStatus, CancellationToken cancellationToken = default(CancellationToken))
       {
            throw new NotImplementedException();
        }
