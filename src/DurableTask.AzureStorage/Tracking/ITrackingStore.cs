...
namespace DurableTask.AzureStorage.Tracking
{
    ...
    interface ITrackingStore
    {
        ...
        /// <returns></returns>
        Task<IList<OrchestrationState>> GetStateAsync(DateTime createdTimeFrom, DateTime createdTimeTo, String RuntimeStatus, CancellationToken cancellationToken = default(CancellationToken));
