...
namespace DurableTask.AzureStorage
{
    ...
    /// </summary>
    public class DependencyTraceContext
    {

#if NETSTANDARD2_0
        private static AsyncLocal<TraceContext> current = new AsyncLocal<TraceContext>();
        private static AsyncLocal<bool> hasTracked = new AsyncLocal<bool>();
        /// <summary>
        ...
        /// </summary>
        public static bool HasTracked
        {
            get { return hasTracked.Value; }
            set { hasTracked.Value = value; }
        }
#else
