...
namespace DurableTask.EventHubs.Partitioning
{
    ...
    class Lease
    {
        /// <summary>Initializes a new instance of the <see cref="DurableTask.EventHubs.Partitioning.Lease" /> class.</summary>
        public Lease()
        {
        }

        /// <summary>Initializes a new instance of the 
        /// <see cref="DurableTask.EventHubs.Partitioning.Lease" /> class with the specified 
        /// <see cref="DurableTask.EventHubs.Partitioning.Lease(DurableTask.EventHubs.Partitioning.Lease)" /> value as reference.</summary> 
        /// <param name="source">The specified <see cref="DurableTask.EventHubs.Partitioning.Lease(DurableTask.EventHubs.Partitioning.Lease)" /> instance where its property values will be copied from.</param>
        ...
        /// <see cref="DurableTask.EventHubs.AzureStorageOrchestrationService" /> object.</summary> 
