...
namespace FrameworkUnitTests
{
    ...
    // Copy of the Functional Tests with SBMP as the protocol
    // TODO : need to factor the tests properly, we are just duplicating for now.

    [TestClass]
    public class FunctionalTestsSbmp
    {
        ...
        public void TestInitialize()
        {
            ...
            {
                client = TestHelpers.CreateSbmpTaskHubClient();
                taskHub = TestHelpers.CreateSbmpTaskHub();
