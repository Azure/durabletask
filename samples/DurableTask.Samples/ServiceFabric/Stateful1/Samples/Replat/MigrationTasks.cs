...
namespace Stateful1.Samples.Replat
{
    ...
    public class MigrationTasks : IMigrationTasks
    {
        ...
        {
            ServiceEventSource.Current.Message($"Export Site Called for SubId: '{subscriptionId}' with Id: '{id}'.  App Name: '{application.Name}'");
        ...
        {
            ServiceEventSource.Current.Message($"Import Site Called for SubId: '{subscriptionId}' with Id: '{id}'.  App Name: '{application.Name}'");
        ...
        {
            ServiceEventSource.Current.Message($"Migrate ServerFarm Called for SubId: '{subscriptionId}' with Id: '{id}'.  App Name: '{application.Name}'");
        ...
        {
            ServiceEventSource.Current.Message($"Update Website Hostname Called for SubId: '{subscriptionId}'.  App Name: '{application.Name}'");
        ...
        {
            ServiceEventSource.Current.Message($"WhitelistSubscription Called for SubId: '{subscriptionId}'.");
        ...
        {
            ServiceEventSource.Current.Message($"CleanupPrivateStamp Called for SubId: '{subscriptionId}'.");
        ...
        {
            ServiceEventSource.Current.Message($"UpdateTtl Called for SubId: '{subscriptionId}'.");
